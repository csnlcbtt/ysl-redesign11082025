    ...
    <div className="modern-page">
      <div className="modern-container section-spacing">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">ISO 9001:2008 Certified Excellence</p>
        </div>

        {/* Quality Policy */}
        <div className="modern-card mb-8">
          <div className="modern-card-header">
            <h2 className="section-title text-white m-0">Quality Policy</h2>
          </div>
        ...
        <div className="modern-card mb-8">
          <div className="modern-card-header">
            <h2 className="section-title text-white m-0">HSE Management Policy</h2>
          </div>
          <div className="modern-card-content">
            <p className="mb-4 leading-relaxed text-gray-700">
        ...
        <div className="modern-card mb-8">
          <div className="modern-card-header">
            <h2 className="section-title text-white m-0 flex items-center gap-4">
              The BSI Group
          ...
          <div className="modern-card-content space-y-4">
            ...
            <div className="mb-4">
              <h3 className="subsection-title">Main Areas of Activities</h3>
              <ul className="space-y-2 pl-4">
                <li className="flex items-start gap-2">
                  <span className="yorke-orange font-bold">•</span>
                  <span className="text-gray-700">Development of private, national and international standards</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="yorke-orange font-bold">•</span>
                  <span className="text-gray-700">Assessment and certification of management systems and medical devices</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="yorke-orange font-bold">•</span>
                  <span className="text-gray-700">Testing and certification of products and services</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="yorke-orange font-bold">•</span>
                  <span className="text-gray-700">Provision of governance, risk and compliance solutions</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="yorke-orange font-bold">•</span>
                  <span className="text-gray-700">Training services</span>
                </li>
              </ul>
            </div>
        ...
        <div className="modern-card mb-8">
          <div className="modern-card-header">
            <h2 className="section-title text-white m-0">Our Commitment to Excellence</h2>
          </div>
          <div className="modern-card-content">
            <p className="mb-4 leading-relaxed text-gray-700">
